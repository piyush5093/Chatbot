...
const API_KEY="AIzaSyC3Gk13wKFjSmN6IdI7fRp0Ogh4vZFml24"
...
const chatHistory=[];
const initialInptHeight=messageInput.scrollHeight;
...
messageInput.addEventListener("input",()=>{
    messageInput.style.height=`${initialInptHeight}px`;
    messageInput.style.height=`${messageInput.scrollHeight}px`;
    document.querySelector(".chat-form").style.borderRadius=messageInput.scrollHeight > initialInptHeight ? "15px" : "32px";
});
